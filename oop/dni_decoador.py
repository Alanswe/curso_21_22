...
class Nif():
    def __init__(self, entero=0, letra=' ') -> None:
        self.entero = entero
        self.letra = letra

    # 3
    def asigna_letra(funcion_DNI):
        def calcula_letra(self, funcion_DNI):
            resto = funcion_DNI % 23
            return resto
        return calcula_letra

        #falta hacer diccionario para contrastar el resto
